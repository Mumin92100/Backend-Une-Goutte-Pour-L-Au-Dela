...
export async function connectMongo() {
  ...
  if (!playersCollection || !goalsCollection || !countersCollection || !adminCollection || !themeCollection) {
    ...
    if (!playerDoc) {
      ...
      await playersCollection.insertOne({ _id: newId, name: "", email: "", password: "", gender: "", goal: "", dateValidate: now.getTime(), secondGoal: "", dateValidateSecond: now.getTime(), thirdGoal: "", dateValidateThird: now.getTime(), level: 1, lastLevelUp: now.getTime(), money: 50, creationDate: now.getTime(), emailSent: false, warningSent: false })
